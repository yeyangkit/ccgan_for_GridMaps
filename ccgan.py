...
class CCGAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        dir_imgPredBel = '/home/yeyang/hartenbach/runs/RESNET_DILATED/watch/11_23_1103_loss=L1_f=16_s=2_d=3_ck=3_norm=ln_lr=5e-4/SELECTED_PRED_4_INPAINTINGmini'
        X_train = datagen.flow_from_directory(dir_imgPredBel, class_mode=None, target_size=(512, 1024), color_mode='grayscale', classes=None, class_mode='input', batch_size=32, shuffle=False, seed=None, save_to_dir=None, save_prefix='', save_format='png', follow_links=False, subset=None, interpolation='nearest') # returns Numpy array Tupel x,y

        # UNITTEST for CIFAR10
        ...
        if K.image_data_format() == 'channels_first':
            X_train = X_train.reshape(X_train.shape[0], 1, 512, 32)
        ...
        X_train = np.array([scipy.misc.imresize(x, [512, 1024]) for x in X_train])
